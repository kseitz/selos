...
bool    ImGui_ImplSdl_Init(SDL_Window *window)
{
	...
	io.RenderDrawListsFn = 0; // ImGui_ImplSdl_RenderDrawLists;   // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.

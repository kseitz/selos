...
#ifndef CIMGUI_DEFAULT
#define CIMGUI_DEFAULT(E) = E
#endif
...
CIMGUI_API void             igSetScrollHere(float center_y_ratio CIMGUI_DEFAULT(0.5f));
CIMGUI_API void             igSetScrollFromPosY(float pos_y, float center_y_ratio CIMGUI_DEFAULT(0.5f));
...
CIMGUI_API bool             igDragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed CIMGUI_DEFAULT(1.0f), float v_min CIMGUI_DEFAULT(0.0f), float v_max CIMGUI_DEFAULT(0.0f), const char* display_format CIMGUI_DEFAULT("%.3f"), const char* display_format_max CIMGUI_DEFAULT(NULL), float power CIMGUI_DEFAULT(1.0f));
...
CIMGUI_API bool             igDragIntRange2(const char* label, int* v_current_min, int* v_current_max, float v_speed CIMGUI_DEFAULT(1.0f), int v_min CIMGUI_DEFAULT(0), int v_max CIMGUI_DEFAULT(0), const char* display_format CIMGUI_DEFAULT("%.0f"), const char* display_format_max CIMGUI_DEFAULT(NULL));
